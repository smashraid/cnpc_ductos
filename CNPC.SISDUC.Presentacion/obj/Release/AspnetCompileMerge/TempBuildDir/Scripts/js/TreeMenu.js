...
function make_tree_tree(id,omit_symbols,no_save_state,singular,no_setup) {
...
TreeMenu.prototype.setup_symbols = function() {
	...
	var states = this.get_tree_states();
	...
	for(var i=0; i < li_elements.length; i++) {
		...
		if(ul_elements.length > 0) {
			...
			ul = ul_elements[0];
			if (states[index] == '1') this.show_tree(ul,li);
			else                      this.hide_tree(ul,li);
			index++;
		}
		else {
			// Menu item
...
TreeMenu.prototype.get_tree_states = function() {
	var cookie = getCookie("tm_" + this.top_ul_id);
	if (cookie) return cookie.split('x');
	return [];
}

TreeMenu.prototype.save_tree_states = function() {
...
TreeMenu.prototype.reset_tree_states = function() {
...
TreeMenu.prototype.show_tree = function(ul,li,e) {
...
TreeMenu.prototype.hide_tree = function(ul,li,e) {
